...
public class RoadMarkAreaGenerator extends AbstractAreaGenerator implements AreaGenerator {
    ...
    public RoadMarkAreaGenerator(Road road) {
        this.road = road;
